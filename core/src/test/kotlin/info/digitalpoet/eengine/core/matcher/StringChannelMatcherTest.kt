...
class StringChannelMatcherTest
{
    ...
    {
        val factory = StringMessageMatcher.Factory()
        ...
        assertThat(matcher.match(mock { on { channel } doReturn "match" }), equalTo(true))
        assertThat(matcher.match(mock { on { channel } doReturn "MATCH" }), equalTo(false))
